...
namespace PMS_POS.View
{
    public partial class RegistrarNuevaCompra : UserControl
    {
        ...
        {
            dgvProductosComprados.DataSource = GetHistList();
        }

        private DataTable GetHistList()//listar historial
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // string Query2 = "INSERT INTO hostal.factura_mostrador (NombreCliente) SELECT NombreCompañia FROM hostal.proveedor WHERE idProveedor = "+txtIdProveedor.Text + "';"; // para insertar una columna a otra tabla
                ...
                MessageBox.Show("Datos Registrados, Total: "+ total.ToString()+ " RD$");
                LoadPrdCompra();
            ...
            try
            {
                ...
                string MyConnection2 = ConfigurationManager.ConnectionStrings["cString"].ConnectionString;
                // This is my insert query in which i am taking input from the user through windows forms  
                string Query = "insert into hostal.factura_mostrador (NombreCliente, TipoFactura, Fecha, Hora,FormaDePago, Total) values ('" + txtIdProveedor.Text + "','" + "CompraProveedor" + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "','" + DateTime.Now.ToString("hh:mm") + "','" + cbxPago.Text + "','" + total + "');";
                //This is  MySqlConnection here i have created the object and pass my connection string.  
                MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                //This is command class which will handle the query and connection object.  
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
            ...
            try
            {
                ...
                string MyConnection2 = ConfigurationManager.ConnectionStrings["cString"].ConnectionString;
                // This is my insert query in which i am taking input from the user through windows forms  
                string Query = "insert into hostal.ajustesinventario (IdInsumo, NombreInsumo, NombreCaja, Accion, CantidadAjuste, FechaModificado) values ('" + txtIdInsumo.Text + "','" + txtNombreProd.Text + "','" + "Nombre Caja" + "','" + "Incremento" + "','" + cantTotal + "','" + DateTime.Now.ToString("yyyy-MM-dd") + "');";
                //This is  MySqlConnection here i have created the object and pass my connection string.  
                MySqlConnection MyConn2 = new MySqlConnection(MyConnection2);
                //This is command class which will handle the query and connection object.  
                MySqlCommand MyCommand2 = new MySqlCommand(Query, MyConn2);
